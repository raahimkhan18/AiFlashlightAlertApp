...
class SMSAlertActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val enabled = PrefsHelper.getBoolean(this, PrefsHelper.KEY_SMS_ENABLED, false)
        val onMs = PrefsHelper.getLong(this, PrefsHelper.KEY_SMS_ON_MS, 500L)
        val offMs = PrefsHelper.getLong(this, PrefsHelper.KEY_SMS_OFF_MS, 500L)
        ...
        alertSwitch.setOnCheckedChangeListener { _, checked ->
            ...
            PrefsHelper.setBoolean(this, PrefsHelper.KEY_SMS_ENABLED, checked)
        }
        ...
        seekOn.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(sb: SeekBar?, p: Int, b: Boolean) {
                ...
                PrefsHelper.setLong(this@SMSAlertActivity, PrefsHelper.KEY_SMS_ON_MS, (p * 10).toLong())
            }
        ...
        seekOff.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener {
            override fun onProgressChanged(sb: SeekBar?, p: Int, b: Boolean) {
                ...
                PrefsHelper.setLong(this@SMSAlertActivity, PrefsHelper.KEY_SMS_OFF_MS, (p * 10).toLong())
            }
            override fun onStartTrackingTouch(p0: SeekBar?) {}
            override fun onStopTrackingTouch(p0: SeekBar?) {}
        })
